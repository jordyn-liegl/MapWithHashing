...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    private void createNewRep(int hashTableSize) {
        ...
        /*
         * Creating an initial representation for the size.
         */
        this.size = 0;

        /*
         * Looping through the size of the hash table and initializing the value
         * of the array at that value with a Map.Pair.
         */
    ...
    public Map4() {
        ...
        /*
         * Use the default hash table size if there is no given argument.
         */
    ...
    public Map4(int hashTableSize) {
        ...
        /*
         * Use the parameter as the hash table size.
         */
    ...
    public final void add(K key, V value) {
        ...
        /*
         * Call the mod method to find which bucket to add the key and value to.
         */
        int bucket = mod(key.hashCode(), this.hashTable.length);
        this.hashTable[bucket].add(key, value);

        /*
         * Increment the size since a new pair is getting added to the map.
         */
        this.size++;
    }
    ...
    public final Pair<K, V> remove(K key) {
        ...
        /*
         * Call the mod method to find which bucket to remove the key from.
         */
        int bucket = mod(key.hashCode(), this.hashTable.length);

        /*
         * Decrement the size since a pair is getting removed from the map.
         */
        this.size--;

        /*
         * Return the pair from the bucket found earlier that is getting
         * removed.
         */
    ...
    public final Pair<K, V> removeAny() {
        ...
        /*
         * Loop through the hash table to find the first non-empty bucket. Once
         * found, decrement the size as the pair in that bucket will be the one
         * removed.
         */
        int bucket = 0;
        ...
        /*
         * Return the removed pair from the found bucket.
         */
    ...
    public final V value(K key) {
        ...
        /*
         * Call the mod method to find which bucket has the key given in the
         * parameter.
         */
        int bucket = mod(key.hashCode(), this.hashTable.length);

        /*
         * Return the value based on the given key from the found bucket.
         */
    ...
    public final boolean hasKey(K key) {
        ...
        /*
         * Return the boolean of whether that bucket has the given key or not.
         */
    ...
    public final int size() {
        /*
         * Return the given size of the map.
         */
        return this.size;
    }
